...
namespace ListsLecture2
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            starTrekCharacters.Sort(); // sorts an alphabetical order for text data and numerical order for numeric data 

            foreach (string starTrekCharacter in starTrekCharacters)
                Console.WriteLine(starTrekCharacter);
            Console.WriteLine();

            starTrekCharacters.Reverse(); // reverse the order of elements in the list
